...
SparseMatrix* transpose_sparse_matrix(SparseMatrix *matrix);//fcja pomocnicza do macierzy sasiedztwa
SparseMatrix* add_sparse_and_transpose_binary(SparseMatrix *matrix);//stad macierz sasiedztwa
SparseMatrix* create_degree_matrix(SparseMatrix *adj_matrix);//na podstawie macierzy sasiedzstwa (tej stworzonej z sumy macierzy saiedzstwa i jej transpozycji)!
